...
object EqualsContract {
     ...
     * of List?
     */
    internal fun <T> permutations(items: List<T>, f: (T, T) -> Unit) {
    ...
    fun <S, T1 : S, T2 : S, T3 : S, T4 : S> equalsHashCode(equiv1: T1, equiv2: T2, equiv3: T3, different: T4, requireDistinctHashes: Boolean) {
        if (equiv1 === equiv2 ||
            equiv1 === equiv3 ||
            equiv1 === different ||
            equiv2 === equiv3 ||
            equiv2 === different ||
            equiv3 === different) {
            throw IllegalArgumentException("You must provide four different (having different memory locations) but 3 equivalent objects")
        }
        val equivs = Arrays.asList(equiv1, equiv2, equiv3)
    ...
    fun <S, T1 : S, T2 : S, T3 : S, T4 : S> equalsSameHashCode(equiv1: T1, equiv2: T2, equiv3: T3, different: T4) {
        equalsHashCode<S, T1, T2, T3, T4>(equiv1, equiv2, equiv3, different, false)
    }
    ...
    fun <S, T1 : S, T2 : S, T3 : S, T4 : S> equalsDistinctHashCode(equiv1: T1, equiv2: T2, equiv3: T3, different: T4) {
        equalsHashCode<S, T1, T2, T3, T4>(equiv1, equiv2, equiv3, different, true)
    }
}